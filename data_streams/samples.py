...
samplelist.append('{"id":10, "value": '+str(round(random()*10, 3))+', "type":"line","active_points": 20, "width":300, "height":150, "label":"value", "legend":"legend", "name":"line chart" }')
...
#samplelist.append('{"id":60, "value": '+str(round(random()*10, 3))+', "type":"polarArea","active_points": 20, "width":300, "height":150, "label":"value", "legend":"legend", "name":"Polar Area chart", "fill": false, "backgroundColor":"#3cba9f", "borderColor":"#c45850"}')
...
#samplelist.append('{"id":90, "value": '+str(round(random()*10, 3))+', "type":"bubble","active_points": 20, "width":300, "height":150, "label":"label", "legend":"legend", "name":"Bubble chart", "fill": false, "backgroundColor":"#e8c3b9", "borderColor":"#c45850"}')
